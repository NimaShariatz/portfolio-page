...
function PopupExp({ triggerPopup, handle_triggerPopup }: PopupExpProps) {
  return(
    ...
    <div className="exp_container" style={{opacity: triggerPopup ? '1' : '0', pointerEvents: triggerPopup ? 'auto' : 'none'}} onClick={() => handle_triggerPopup('Exp_popup')}>
      <div className="exp_content" style={{transform: triggerPopup ? 'translateY(-12px)' : 'translateY(0px)'}} onClick={(e) => e.stopPropagation()}>
        
        <div className="topSection exp_topSection">
          <p>Experience</p>
          <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 20 20" onClick={() => handle_triggerPopup('Exp_popup')}>
